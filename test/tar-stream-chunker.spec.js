...
test('should create TAR with more than 1 chunk if stdin has 1024*1024 bytes length with slow data production and user asked for chunk size in 1024 bytes', t.pipe(
  t.run .mktemp('orig'),
